...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { color: @planet.color, distance: @planet.distance, name: @planet.name, size: @planet.size } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { color: @planet.color, distance: @planet.distance, name: @planet.name, size: @planet.size } }
